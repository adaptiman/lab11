...
create webapp: az webapp create --resource-group WPRG --plan WPServicePlan --name davidswp --multicontainer-config-type compose --multicontainer-config-file compose-wordpress-step1.yml
...
update webapp: az webapp config container set --resource-group WPRG --name davidswp --multicontainer-config-type compose --multicontainer-config-file compose-wordpress-step2.yml
